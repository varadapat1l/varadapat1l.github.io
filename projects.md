...
* Allows for users to open crossword puzzle files through a 'Crossword' class, input guesses, and obtain correct answers
* Incorporates functions to validate user inputs based on various command options and display clues if prompted for by user
* Users are able to view the menu, quit, or restart the game as desired
